    ...
    return (
        ...
        <div className="flex flex-col y-gap-2 px-2 py-3 rounded-b-md h-110 ">
            ...
            <div className="flex justify-center mb-1">
                <a target={"_blank"} href={`https://etherscan.io/token/${nft.contract.address}`} className="py-2 px-4 bg-blue-100 w-1/2 text-center rounded-m text- cursor-pointer">View on etherscan</a>
            </div>
        </div>
